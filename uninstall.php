 ...
 * of control:
 *
 * - Check if the $_REQUEST['plugin'] content actually is themc-core/themc-core.php
 ...
 * @since 0.0.1
 */
function themc_core_uninstall() {

	if ( ! defined( 'WP_UNINSTALL_PLUGIN' )
		|| empty( $_REQUEST )
		|| ! isset( $_REQUEST['plugin'] )
		|| ! isset( $_REQUEST['action'] )
		|| 'themc-core/themc-core.php' !== $_REQUEST['plugin']
